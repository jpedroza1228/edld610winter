...
library(ggalt)
library(ggpubr)
#added this to help display multiple plots at once
...
p3 <- ggplot(data, aes(gender, days_active_60)) +
  geom_col(alpha = .7, position = "dodge2", aes(fill = race)) +
  scale_fill_viridis_d() +
  theme_minimal() +
  coord_flip() +
...
p4 <- ggplot(data, aes(gender, days_active_60)) +
  geom_col(alpha = .7, position = "dodge2", aes(fill = income)) +
  scale_fill_viridis_d() +
  theme_minimal() +
  coord_flip() +
...
p5 <- ggplot(data, aes(mod_work, vig_work)) +
...
p6<- ggplot(data, aes(mod_rec_pa, vig_rec_pa)) +
